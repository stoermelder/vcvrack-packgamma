...
cat <<- EOH
## Automatically generated PackGamma build
...
The latest stable build can be found at the [VCV Library](https://vcvrack.com/plugins.html#packgamma).

These assets were built against
https://vcvrack.com/downloads/Rack-SDK-1.1.5.zip
