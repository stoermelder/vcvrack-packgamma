...
struct OphMk1Widget : ModuleWidget {
	OphMk1Widget(OphMk1Module* module) {
		...
		addParam(createParamCentered<Trimpot>(Vec(22.5f, 108.5f), module, OphMk1Module::FBK_PARAM));
		addParam(createParamCentered<CKSSH>(Vec(22.5f, 139.8f), module, OphMk1Module::FBKTAPER_PARAM));

		addParam(createParamCentered<Trimpot>(Vec(22.5f, 205.2f), module, OphMk1Module::FREQ_PARAM));
		addParam(createParamCentered<Trimpot>(Vec(22.5f, 235.2f), module, OphMk1Module::FINE_PARAM));
